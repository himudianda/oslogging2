...
MAINTAINER Harshit Imudianda http://github.com/himudianda
...
ADD ./configs/logstash/init/logstash-init /etc/init.d/logstash
...
ADD ./configs/kibana/init/kibana-init /etc/init.d/kibana
...
ADD ./configs/elasticsearch/elasticsearch.yml /etc/elasticsearch/elasticsearch.yml
...
# filters
ADD ./configs/logstash/beats-input.conf /etc/logstash/conf.d/beats-input.conf
ADD ./configs/logstash/syslog.conf /etc/logstash/conf.d/syslog.conf
ADD ./configs/logstash/nginx.conf /etc/logstash/conf.d/nginx.conf
ADD ./configs/logstash/output.conf /etc/logstash/conf.d/output.conf

# patterns
ADD ./configs/logstash/patterns/nginx.pattern ${LOGSTASH_HOME}/patterns/nginx
